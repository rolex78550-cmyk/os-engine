...
export const DEFAULT_QUESTS: QuestDef[] = [
  ...
  // ===== Sensor-tracked workout quests (auto-routed to motion tracker) =====
  {
    id: "default-pushup-50",
    title: "50 PUSH-UPS",
    category: "body",
    rank: "D",
    xp: 100,
    questType: "side",
    description: "Complete 50 push-ups. Place your phone in your chest pocket and let the motion sensor count every rep automatically.",
  },
  {
    id: "default-squat-50",
    title: "50 SQUATS",
    ...
    xp: 150,
    questType: "side",
    description: "Complete 50 bodyweight squats. Phone in your front pocket — the sensor detects Y-axis drop + Z-axis forward tilt per rep.",
  },
  {
    id: "default-plank-2min",
    title: "2 MIN PLANK",
    category: "body",
    rank: "D",
    xp: 100,
    questType: "side",
    description: "Hold a plank for 2 minutes. Place your phone on your back — the stillness timer runs while you hold the position.",
  },
  {
    id: "default-walk-5k",
    title: "5,000 STEPS WALK",
    category: "body",
    rank: "C",
    xp: 150,
    questType: "side",
    description: "Walk 5,000 steps today. Phone in your pocket — accelerometer peaks count every step automatically.",
  },
  {
    id: "default-meditation-10min",
    title: "10 MIN MEDITATION",
    category: "mind",
    rank: "D",
    xp: 100,
    questType: "side",
    description: "Meditate for 10 minutes. Phone face-up beside you — stillness detector tracks your calm.",
  },
  // ===== Other default quests (selfie/video proof) =====
  {
...
export const BOSS_QUESTS: QuestDef[] = [
  {
    ...
    bossImage: "/images/sd_igris_red.jpg",
  },
  {
    id: "boss-comfort",
    ...
    bossImage: "/images/sd_jin_shadow.jpg",
  },
  {
    id: "boss-distraction",
...
export const CHARACTER_TIERS: CharacterTier[] = [
  ...
  },
  {
    ...
    image: "/images/sd_jin_minimal.jpg",
    accent: "slate",
  ...
  },
  {
    ...
    image: "/images/sd_jin_shadow.jpg",
    accent: "amber",
